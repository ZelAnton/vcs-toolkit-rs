...
impl<R: ProcessRunner> Git<R> {
    ...
    /// be cancelled, leaving the merge in the working tree. Overriding the token
    /// with a fresh, never-fired [`CancellationToken`] (and giving the cleanup a
