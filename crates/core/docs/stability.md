...
| Crate | Version | Tier |
|---|---|---|
| `vcs-diff` | 0.8.0 | settling |
| `vcs-cli-support` | 0.8.0 | settling |
| `vcs-testkit` | 0.8.0 | stable-ish (dev-only) |
| `vcs-git` | 0.12.0 | maturing |
| `vcs-jj` | 0.12.0 | maturing |
| `vcs-github` | 0.12.0 | maturing |
| `vcs-core` | 0.10.0 | evolving |
| `vcs-gitlab` | 0.8.0 | evolving |
| `vcs-gitea` | 0.8.0 | evolving |
